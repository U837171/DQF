...
PARAMS_FILE = "derivative_valuation_basic_params.csv"
MARKET_FILE = "derivative_valuation_basic_market.csv"
...
def case_study():
    ...
    result = run_topic_case("forward_swap_sensitivities", params, market, paths_array)
...
CASE_DISPATCH = {
    "forward_swap_sensitivities": case_forward_swap_sensitivities,
}
...
def plot_case_study(show=True, save_path=None):
    ...
    case_name = "forward_swap_sensitivities"
    if case_name == "svi_surface":
        ...
        ax.set_title("Derivative Valuation Basic: SVI implied-volatility surface")
        ...
        ax.set_title("Derivative Valuation Basic: simulated path surface")
        ...
        ax.set_title("Derivative Valuation Basic: simulated risk-neutral paths")
        ax.set_xlabel("time step")
...
if __name__ == "__main__":
    outputs = case_study()
    print("Derivative Valuation Basic")
    print("-" * len("Derivative Valuation Basic"))
