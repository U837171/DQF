...
PARAMS_FILE = "rfr_regime_params.csv"
MARKET_FILE = "rfr_regime_market.csv"
...
def case_study():
    ...
    result = run_topic_case("ois_curve_bootstrap", params, market, paths_array)
...
CASE_DISPATCH = {
    "ois_curve_bootstrap": case_ois_curve_bootstrap,
}
...
def plot_case_study(show=True, save_path=None):
    ...
    if case_name == "svi_surface":
        ...
        ax.set_title("RFR Regime and Curve Construction: SVI implied-volatility surface")
        ...
        ax.set_title("RFR Regime and Curve Construction: simulated path surface")
        ...
        ax.set_title("RFR Regime and Curve Construction: simulated risk-neutral paths")
        ax.set_xlabel("time step")
...
if __name__ == "__main__":
    outputs = case_study()
    print("RFR Regime and Curve Construction")
    print("-" * len("RFR Regime and Curve Construction"))
