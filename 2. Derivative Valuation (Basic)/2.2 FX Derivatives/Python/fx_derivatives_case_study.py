...
PARAMS_FILE = "fx_derivatives_params.csv"
MARKET_FILE = "fx_derivatives_market.csv"
...
def case_study():
    ...
    result = run_topic_case("fx_forwards_options", params, market, paths_array)
...
CASE_DISPATCH = {
    "fx_forwards_options": case_fx_forwards_options,
}
...
def plot_case_study(show=True, save_path=None):
    ...
    if case_name == "svi_surface":
        ...
        ax.set_title("FX Derivatives: SVI implied-volatility surface")
        ...
        ax.set_title("FX Derivatives: simulated path surface")
        ...
        ax.set_title("FX Derivatives: simulated risk-neutral paths")
        ax.set_xlabel("time step")
...
if __name__ == "__main__":
    outputs = case_study()
    print("FX Derivatives")
    print("-" * len("FX Derivatives"))
