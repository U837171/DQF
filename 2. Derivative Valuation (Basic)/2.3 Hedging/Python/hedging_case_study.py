...
PARAMS_FILE = "hedging_params.csv"
MARKET_FILE = "hedging_market.csv"
...
def case_study():
    ...
    result = run_topic_case("delta_hedging_error", params, market, paths_array)
...
CASE_DISPATCH = {
    "delta_hedging_error": case_delta_hedging_error,
}
...
def plot_case_study(show=True, save_path=None):
    ...
    if case_name == "svi_surface":
        ...
        ax.set_title("Hedging: SVI implied-volatility surface")
        ...
        ax.set_title("Hedging: simulated path surface")
        ...
        ax.set_title("Hedging: simulated risk-neutral paths")
        ax.set_xlabel("time step")
