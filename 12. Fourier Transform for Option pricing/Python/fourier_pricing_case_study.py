...
PARAMS_FILE = "fourier_pricing_params.csv"
MARKET_FILE = "fourier_pricing_market.csv"
...
def case_study():
    ...
    result = run_topic_case("fourier_characteristic_function", params, market, paths_array)
...
CASE_DISPATCH = {
    "fourier_characteristic_function": case_fourier_characteristic_function,
}
...
def plot_case_study(show=True, save_path=None):
    ...
    case_name = "fourier_characteristic_function"
    if case_name == "svi_surface":
        ...
        ax.set_title("Fourier Transform for Option Pricing: SVI implied-volatility surface")
        ...
        ax.set_title("Fourier Transform for Option Pricing: simulated path surface")
        ...
        ax.set_title("Fourier Transform for Option Pricing: simulated risk-neutral paths")
        ax.set_xlabel("time step")
...
if __name__ == "__main__":
    outputs = case_study()
    print("Fourier Transform for Option Pricing")
    print("-" * len("Fourier Transform for Option Pricing"))
