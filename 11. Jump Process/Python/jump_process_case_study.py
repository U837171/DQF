...
PARAMS_FILE = "jump_process_params.csv"
MARKET_FILE = "jump_process_market.csv"
...
def case_study():
    ...
    result = run_topic_case("merton_jump_diffusion", params, market, paths_array)
...
CASE_DISPATCH = {
    "merton_jump_diffusion": case_merton_jump_diffusion,
}
...
def plot_case_study(show=True, save_path=None):
    ...
    case_name = "merton_jump_diffusion"
    if case_name == "svi_surface":
        ...
        ax.set_title("Jump Processes: SVI implied-volatility surface")
        ...
        ax.set_title("Jump Processes: simulated path surface")
        ...
        ax.set_title("Jump Processes: simulated risk-neutral paths")
        ax.set_xlabel("time step")
...
if __name__ == "__main__":
    outputs = case_study()
    print("Jump Processes")
    print("-" * len("Jump Processes"))
