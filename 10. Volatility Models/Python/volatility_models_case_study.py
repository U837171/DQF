...
PARAMS_FILE = "volatility_models_params.csv"
MARKET_FILE = "volatility_models_market.csv"
...
def case_study():
    ...
    result = run_topic_case("svi_surface", params, market, paths_array)
...
def plot_case_study(show=True, save_path=None):
    ...
    if case_name == "svi_surface":
        ...
        ax.set_title("Volatility Models: SVI implied-volatility surface")
        ...
        ax.set_title("Volatility Models: simulated path surface")
        ...
        ax.set_title("Volatility Models: simulated risk-neutral paths")
        ax.set_xlabel("time step")
