...
PARAMS_FILE = "asian_options_params.csv"
MARKET_FILE = "asian_options_market.csv"
...
def case_study():
    ...
    result = run_topic_case("asian_mc_control_variate", params, market, paths_array)
...
CASE_DISPATCH = {
    "asian_mc_control_variate": case_asian_mc_control_variate,
}
...
def plot_case_study(show=True, save_path=None):
    ...
    case_name = "asian_mc_control_variate"
    if case_name == "svi_surface":
        ...
        ax.set_title("Asian Options: SVI implied-volatility surface")
        ...
        ax.set_title("Asian Options: simulated path surface")
        ...
        ax.set_title("Asian Options: simulated risk-neutral paths")
        ax.set_xlabel("time step")
