...
PARAMS_FILE = "stochastics_params.csv"
MARKET_FILE = "stochastics_market.csv"
...
def case_study():
    ...
    result = run_topic_case("brownian_girsanov", params, market, paths_array)
...
CASE_DISPATCH = {
    "brownian_girsanov": case_brownian_girsanov,
}
...
def plot_case_study(show=True, save_path=None):
    ...
    if case_name == "svi_surface":
        ...
        ax.set_title("Stochastics: SVI implied-volatility surface")
        ...
        ax.set_title("Stochastics: simulated path surface")
        ...
        ax.set_title("Stochastics: simulated risk-neutral paths")
        ax.set_xlabel("time step")
