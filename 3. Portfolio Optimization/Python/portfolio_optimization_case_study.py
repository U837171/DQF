...
PARAMS_FILE = "portfolio_optimization_params.csv"
MARKET_FILE = "portfolio_optimization_market.csv"
...
def case_study():
    ...
    result = run_topic_case("factor_portfolio_optimization", params, market, paths_array)
...
CASE_DISPATCH = {
    "factor_portfolio_optimization": case_factor_portfolio_optimization,
}
...
def plot_case_study(show=True, save_path=None):
    ...
    case_name = "factor_portfolio_optimization"
    if case_name == "svi_surface":
        ...
        ax.set_title("Portfolio Optimization: SVI implied-volatility surface")
        ...
        ax.set_title("Portfolio Optimization: simulated path surface")
        ...
        ax.set_title("Portfolio Optimization: simulated risk-neutral paths")
        ax.set_xlabel("time step")
...
if __name__ == "__main__":
    ...
    print("-" * len("Portfolio Optimization"))
