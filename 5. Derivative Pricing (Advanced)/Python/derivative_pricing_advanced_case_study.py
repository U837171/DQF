...
PARAMS_FILE = "derivative_pricing_advanced_params.csv"
MARKET_FILE = "derivative_pricing_advanced_market.csv"
...
def case_study():
    ...
    result = run_topic_case("measure_change_tree", params, market, paths_array)
...
CASE_DISPATCH = {
    "measure_change_tree": case_measure_change_tree,
}
...
def plot_case_study(show=True, save_path=None):
    ...
    if case_name == "svi_surface":
        ...
        ax.set_title("Derivative Pricing Advanced: SVI implied-volatility surface")
        ...
        ax.set_title("Derivative Pricing Advanced: simulated path surface")
        ...
        ax.set_title("Derivative Pricing Advanced: simulated risk-neutral paths")
        ax.set_xlabel("time step")
...
if __name__ == "__main__":
    outputs = case_study()
    print("Derivative Pricing Advanced")
    print("-" * len("Derivative Pricing Advanced"))
