...
PARAMS_FILE = "black_scholes_params.csv"
MARKET_FILE = "black_scholes_market.csv"
...
def case_study():
    ...
    result = run_topic_case("bsm_greeks_pde", params, market, paths_array)
...
CASE_DISPATCH = {
    "bsm_greeks_pde": case_bsm_greeks_pde,
}
...
def plot_case_study(show=True, save_path=None):
    ...
    if case_name == "svi_surface":
        ...
        ax.set_title("Black-Scholes: SVI implied-volatility surface")
        ...
        ax.set_title("Black-Scholes: simulated path surface")
        ...
        ax.set_title("Black-Scholes: simulated risk-neutral paths")
        ax.set_xlabel("time step")
