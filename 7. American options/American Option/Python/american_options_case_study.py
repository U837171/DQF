...
def case_study():
    ...
    result = run_topic_case("american_lsm", params, market, paths_array)
...
CASE_DISPATCH = {
    "american_lsm": case_american_lsm,
}
...
def plot_case_study(show=True, save_path=None):
    ...
    if case_name == "svi_surface":
        ...
        ax.set_title("American Options: SVI implied-volatility surface")
        ...
        ax.set_title("American Options: simulated path surface")
        ...
        ax.set_title("American Options: simulated risk-neutral paths")
        ax.set_xlabel("time step")
